...
namespace EdB.PrepareCarefully {
    public class ProviderBackstories {
        ...
        public ProviderBackstories() {
            ...
            List<BackstoryDef> backstories = BackstoryDatabase.allBackstories.Values.ToList();
        ...
        private void InitializeBackstoriesForPawnKind(PawnKindDef def) {
            ...
            List<BackstoryDef> childhood = BackstoryDatabase.allBackstories.Values.Where((b) => {
            ...
            List<BackstoryDef> adulthood = BackstoryDatabase.allBackstories.Values.Where((b) => {
